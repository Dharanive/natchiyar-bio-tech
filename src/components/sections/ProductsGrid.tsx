...
const ProductsGrid = ({ category }: ProductsGridProps) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-green-800 via-yellow-600 to-green-700 text-white py-24 overflow-hidden">
          ...
          style={{
            backgroundImage: `url('data:image/svg+xml;base64,${btoa(`
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
                <rect width="1920" height="1080" fill="url(#farmGradient)"/>
                <defs>
                  <linearGradient id="farmGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style="stop-color:#1f4b3f;stop-opacity:1" />
