...
const Masonry: React.FC<MasonryProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    grid.forEach((item) => {
      ...
      if (!triggerAnimation && !hasAnimated.current) {
        ...
        // Just position without animation for layout changes
  ...
  }, [grid, imagesReady, triggerAnimation]);

  // Trigger animation when triggerAnimation becomes true
  useLayoutEffect(() => {
    if (!imagesReady || !triggerAnimation || hasAnimated.current || !grid.length) return;
  ...
  }, [grid, imagesReady, triggerAnimation, stagger, animateFrom, blurToFocus, duration, ease]);
